...
class fren_Cambridge {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return '剑桥西英词典';
        if (locale.indexOf('TW') != -1) return '剑西法英词典';
        return 'Cambridge ES->EN Dictionary';
    }
    ...
    async findCambridge(word) {
        ...
        let base = 'https://dictionary.cambridge.org/search/spanish-english/direct/?q=';
