...
class enen_UrbanDict {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return 'ENES WordReference';
        if (locale.indexOf('TW') != -1) return 'ENES WordReference';
        return 'ENES WordReference';
    }
    ...
    async findUrbanDict(word) {
        ...
        let base = 'https://www.wordreference.com/es/en/translation.asp?spen=';
